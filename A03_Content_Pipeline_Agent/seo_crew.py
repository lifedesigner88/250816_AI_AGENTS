    ...
    def seo_export(self):
        return Agent(
            ...
            goal="""Analyze blog posts for Seo optimization and provide a score with detailed reasoning.
                Be very demanding, don't give underserved good scores.""",
            backstory=""" You are an experienced SEO specialist with expertise in content optimization.
                You analyze blog posts for keyword usage, meta descriptions, content structure, readabillity,
    ...
    def seo_audit(self):
        return Task(
            ...
            expected_output="""A Score object with:
                - score : integer from 0-10 rating hte Seo quality
                - reason : string explaining the main factors affecting the score """,
            agent=self.seo_export(),
