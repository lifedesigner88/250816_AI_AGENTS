...
- **CRITICAL - Style Consistency**: Maintain the same visual style, tone, lighting approach, and aesthetic across ALL prompts. 
If the first scene uses warm lighting and photorealistic style, 
ALL subsequent scenes must use the same approach for visual cohesion.
