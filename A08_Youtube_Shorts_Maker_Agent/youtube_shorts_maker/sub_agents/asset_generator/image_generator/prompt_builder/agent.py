...
from .prompt import PROMPT_BUILDER_PROMPT, PROMPT_BUILDER_DESCRIPTION
...
class OptimizedPrompt(BaseModel):
    ...
    enhanced_prompt:str = Field(
        description="Detailed prompt with technical specs and text overlay instructions for verical YouTube Shorts"
    )
